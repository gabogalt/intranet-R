...
<head>
  ...
  <title>RE/MAX Rio - Merchandising</title>
  <meta charset="UTF-8">
...
<div class="container-fluid bg-light mt-3 p-5 animate__animated animate__slideInLeft" > 
    ...
    <div class="shadow-lg p-3 mb-5 bg-body rounded">
    	<h2>Merchandising RE/MAX RIO</h2>
    	<div class="row">
    		<h4 class="text-danger">IMPORTANTE: Este Calendario puede verse en el navegador Google Chrome.</h4>
    		<div class="col d-flex justify-content-center ">
				<iframe src="https://drive.google.com/file/d/1oY6P3Ofk-mdYOdeVISl-1spGWoNfXGBv/preview" width="640" height="480" ></iframe>
