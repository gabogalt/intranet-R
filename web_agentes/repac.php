...
<head>
  ...
  <title>RE/MAX Rio - Reporte de actividades</title>
  <meta charset="UTF-8">
    ...
    <div class="shadow-lg p-3 mb-5 bg-body rounded">
    	<div class="row">
    		<div class="col ">
    			...
    			<p>
    				Para presentar a nuestros clientes un informe de la respuesta del mercado a la publicación de su propiedad.
    			</p>
    			<div class="d-grid gap-2 d-flex justify-content-md-end">
				  <button class="btn btn-primary " type="button"><a href="https://drive.google.com/file/d/1PLqrv6Sbi5OUkxtJFHDJUG3HMFfquMJx/view?usp=sharing" class="btn azul" style="text-decoration: none; color: white ">Descargar "Reporte de Actividades"</a></button>
				</div>
