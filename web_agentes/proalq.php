...
<head>
  ...
  <title>RE/MAX Rio - Proceso de locación</title>
  <meta charset="UTF-8">
...
<div class="container-fluid bg-light mt-3 p-5 animate__animated animate__slideInLeft" > 
    ...
    <div class="shadow-lg p-3 mb-5 bg-body rounded">
    	<div class="row">
        <h2>Proceso general para locación</h2>
    		<div class="col ">
    			<ol >
            ...
            <li> <Font Color="black">Carga en el sistema + Pedido de alta a la oficina</li></font>
            <li> <Font Color="black">Colocar cartel</li></font>
            <li> <Font Color="black">Campañas de marketing - Visitas</li></font>
            <li> <Font Color="black">Reserva + Entrega de documentación del locatario</li></font>
            <li> <Font Color="black">Estado crediticio locatario y garante</li></font>
            <li> <Font Color="black">Aceptación del propietario </li></font>
            <li> <Font Color="black">Notificación del dador de la reserva de la aceptación </li></font>
            <li> <Font Color="black">Informes: frecuencia y dominio</li></font>
            <li> <Font Color="black"> Redactar Contrato de Locación </li></font>
            <li> <Font Color="black"> Presentación del contrato, informes y D.N.I. a legales </li></font>
            <li> <Font Color="black"> Emisión de facturas</li></font>
            <li> <Font Color="black">Firma del contrato + Formularios UIF</li></font>
