...
<div class="container-fluid bg-light mt-3 p-5 animate__animated animate__slideInLeft" > 
    ...
    <div class="shadow-lg p-3 mb-5 bg-body rounded">
    	<div class="row">
    		<div class="col ">
    			<h2>Formulario pedido de COTI</h2>
          <p>Debemos completarlo y enviarlo junto con el pedido de activación de la propiedad.</p>
    			<div class="d-grid gap-2 d-flex justify-content-md-end">
				  <button class="btn btn-primary " type="button"><a href="https://drive.google.com/file/d/1E0kEWeTi24ptR06HpuxCOD3Gbk1rxMaC/view?usp=sharing" class="btn azul" style="text-decoration: none; color: white ">Descargar "Formulario pedido de COTI"</a>
          </button>
				</div>
