...
<head>
  ...
  <title>RE/MAX Rio - Calendario RIO</title>
  <meta charset="UTF-8">
...
<div class="container-fluid bg-light mt-3 p-5 animate__animated animate__slideInLeft" > 
    ...
    <div class="shadow-lg p-3 mb-5 bg-body rounded">
    	<h2>Calendario Rio</h2>
    	<div class="row">
    		<h4 class="text-danger">IMPORTANTE: Este Calendario puede verse en el navegador Google Chrome.</h4>
    		<div class="col d-flex justify-content-center ">
				<iframe src="https://calendar.google.com/calendar/embed?src=rio%40remax.com.ar&ctz=America%2FArgentina%2FBuenos_Aires" class="" width="1000" height="800" frameborder="0" scrolling="no"></iframe>
