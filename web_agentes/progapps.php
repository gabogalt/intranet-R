...
<div class="container  animate__animated animate__slideInLeft  " >
  ...
  <div class="row bg-light p-5"    style="border-radius: 30px;border: white 10px outset;  ">
    ...
    <div class="d-grid gap-2 d-flex justify-content-md-end">
		  <button class="btn btn-primary " type="button"><a href="https://www.canva.com/" style="text-decoration: none; color: white "></a>Enlace a Canva</button>
	</div>
    ...
    <div class="d-grid gap-2 d-flex justify-content-md-end">
		  <button class="btn btn-primary mb-3 " type="button"><a href="https://floorplanner.com/" style="text-decoration: none; color: white "></a>Enlace a Floorplanner</button>
	</div>
	...
	<p>
		Para el c�lculo de días hábiles, se consideran los feriados inamovibles, trasladables, puentes tur�sticos y días nolaborables nacionales, establecidos y publicados por el Gobierno Nacional. Es la p�gina del Colegio de Escribanos de la Provincia de Buenos Aires 
	</p>
    <div class="d-grid gap-2 d-flex justify-content-md-end">
		  <button class="btn btn-primary " type="button"><a href="https://www.colescba.org.ar/www/pages/calculadoraFechas/calculadoraDeFechas.jsf" style="text-decoration: none; color: white "></a>Enlace C�lculo de fechas</button>
	</div>
  </div>
  <div class="col " style="border-radius: 30px; ">
     
    <h4 class="text-primary">CamScanner</h4>
    <p>Es una aplicación móvil que permite utilizar dispositivos iOS y Android como escáneres de im�genes. Permite a los usuarios "escanear" documentos y compartir la foto como JPEG o PDF.</p>
    ...
    <div class="d-grid gap-2 d-flex justify-content-md-end">
		  <button class="btn btn-primary " type="button"><a href="https://cleanup.pictures/" style="text-decoration: none; color: white "></a>Enlace a Cleanup.pictures</button>
	</div>
