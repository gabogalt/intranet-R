...
<head>
  ...
  <title>RE/MAX Rio - Baja de precio</title>
  <meta charset="UTF-8">
...
<div class="container-fluid bg-light mt-3 p-5 animate__animated animate__slideInLeft" > 
    ...
    <div class="shadow-lg p-3 mb-5 bg-body rounded">
    	<div class="row">
    		<h2>Baja de precio</h2>
    		<div class="col ">
				<img class=" animate__animated animate__flipInX " src="../imagenes/bajaprecios.jpg"  style="max-width:100%;width:auto;height:auto;">
