            ...
            <h2>Procesos</h2>
              ...
              <ul>
                 <li> <a href="proven.php" class="dropdown-item text-primary">Proceso general de VENTA</a> </li>
                  <li> <a href="proalq.php" class="dropdown-item text-primary">Proceso general de LOCACIÓN</a> </li>
                  <li> <a href="objcli.php" class="dropdown-item text-primary">Objeciones del cliente</a> </li>
                  <li> <a href="fotvid.php" class="dropdown-item text-primary">Producción visual - Plano</a> </li>
                  <li> <a href="doccap.php" class="dropdown-item text-primary">Captación: Documentos requeridos</a> </li>
                  ...
                  <li> <a href="dialoc.php" class="dropdown-item text-primary">Firma del contrato de locación - Gastos</a> </li>
              </ul>
