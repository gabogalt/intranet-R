...
<div class="container-fluid bg-light mt-3 p-5 animate__animated animate__slideInLeft" > 
    ...
    <div class="shadow-lg p-3 mb-5 bg-body rounded">
    	<div class="row">
    		<h2>DISC</h2>
    		<div class="col-5 ">
				<img class="centrado" src="../imagenes/Disc2.jpg"  style="max-width:100%;width:auto;height:auto;">
				    
			</div>

			<div class="col-7">
				
				<img class="centrado"src="../imagenes/Disc3.jpg"  style="max-width:120%">
