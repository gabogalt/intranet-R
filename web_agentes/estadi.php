...
<head>
  ...
  <title>RE/MAX Rio - Estadísticas</title>
  <meta charset="UTF-8">
...
<div class="container-fluid bg-light mt-3 p-5 animate__animated animate__slideInLeft" > 
    ...
    <div class="shadow-lg p-3 mb-5 bg-body rounded">
    	<div class="row">
    		<div class="col ">
    			<h2>Estadísticas RE/MAX</h2>
			    
					<div class="d-grid gap-2 d-flex justify-content-md-end">
					  <button class="btn btn-primary " type="button"><a href="https://drive.google.com/file/d/1by0BGXs79qArNOJhbGg6hIb3MpZwHMf0/view?usp=sharing"style="text-decoration: none; color: white ">Valor metro cuadrado primer semestre 2021</a></button>
					</div>
