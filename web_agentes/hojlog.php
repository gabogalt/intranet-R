...
<head>
  ...
  <title>RE/MAX Rio - Hoja con logo</title>
  <meta charset="UTF-8">
    	...
    	<div class="row">
    		<div class="col ">
    			...
    			<div class="d-grid gap-2 d-flex justify-content-md-end">
				  <button class="btn btn-primary " type="button"><a style="text-decoration: none; color: white " href="https://drive.google.com/file/d/1XYkB1jHz5Y6cOCcDipUjcK5TS-k-D0_r/view?usp=sharing">Descargar Hoja con logo</a></button>
				</div>
